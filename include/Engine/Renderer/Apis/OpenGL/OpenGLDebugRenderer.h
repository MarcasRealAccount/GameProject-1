...
namespace gp1::renderer::opengl
{
	...
	private:
		static smart_pointers::shared_ptr<ShaderProgram> s_DebugShaderProgram;

	public:
		inline virtual smart_pointers::shared_ptr<Mesh> GetMesh() const override
		{
			return m_Mesh;
		}

		inline virtual smart_pointers::shared_ptr<Material> GetMaterial() const override
		{
			return m_Material;
		}

	protected:
		OpenGLDebugObject(float duration, const glm::fvec4& color, const smart_pointers::shared_ptr<Mesh>& mesh);

	protected:
		float m_SpawnTime;
		float m_Duration;

		smart_pointers::shared_ptr<Mesh>     m_Mesh;
		smart_pointers::shared_ptr<Material> m_Material;
	};
	...
	private:
		static smart_pointers::shared_ptr<StaticMesh> s_PointMesh;
	...
	private:
		static smart_pointers::shared_ptr<StaticMesh> s_SphereMesh;
	...
	private:
		static smart_pointers::shared_ptr<StaticMesh> s_BoxMesh;
	...
	private:
		static smart_pointers::shared_ptr<StaticMesh> s_LineMesh;
	...
	private:
		std::vector<smart_pointers::shared_ptr<OpenGLDebugObject>> m_Entities;
	};
} // namespace gp1::renderer::opengl
#endif