...
namespace gp1::renderer::opengl
{
	...
	void OpenGLUniformTexture2D::Update()
	{
		...
		smart_pointers::reinterpret_pointer_cast<OpenGLTexture2D>(m_Value)->Update();
	}
	...
	void OpenGLUniformTexture2D::Bind()
	{
		if (m_Value)
		{
			...
			glBindTexture(GL_TEXTURE_2D, smart_pointers::reinterpret_pointer_cast<OpenGLTexture2D>(m_Value)->m_TextureId);
		}
		else
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
	...
	void OpenGLUniformTexture2DArray::Update()
	{
		...
		smart_pointers::reinterpret_pointer_cast<OpenGLTexture2DArray>(m_Value)->Update();
	}
	...
	void OpenGLUniformTexture2DArray::Bind()
	{
		...
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
			glBindTexture(GL_TEXTURE_2D_ARRAY, smart_pointers::reinterpret_pointer_cast<OpenGLTexture2DArray>(m_Value)->m_TextureId);
		}
		else
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
	...
	void OpenGLUniformTexture3D::Update()
	{
		...
		smart_pointers::reinterpret_pointer_cast<OpenGLTexture3D>(m_Value)->Update();
	}
	...
	void OpenGLUniformTexture3D::Bind()
	{
		...
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
			glBindTexture(GL_TEXTURE_3D, smart_pointers::reinterpret_pointer_cast<OpenGLTexture3D>(m_Value)->m_TextureId);
		}
		else
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
	...
	void OpenGLUniformTextureCubeMap::Update()
	{
		...
		smart_pointers::reinterpret_pointer_cast<OpenGLTextureCubeMap>(m_Value)->Update();
	}
	...
	void OpenGLUniformTextureCubeMap::Bind()
	{
		...
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
			glBindTexture(GL_TEXTURE_CUBE_MAP, smart_pointers::reinterpret_pointer_cast<OpenGLTextureCubeMap>(m_Value)->m_TextureId);
		}
		else
		{
			glActiveTexture(GL_TEXTURE0 + m_Offset);
