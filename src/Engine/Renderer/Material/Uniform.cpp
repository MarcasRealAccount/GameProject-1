...
namespace gp1::renderer
{
	...
	Uniform* Uniform::Create(EUniformType type)
	{
	...
	UniformBuffer::UniformInfo::UniformInfo(const std::string& name, Uniform* uniform)
	    : m_Name(name), m_Uniform(uniform) {}

	UniformBuffer::UniformInfo::UniformInfo(UniformInfo&& move) noexcept
	{
		m_Name         = std::move(move.m_Name);
		m_Uniform      = move.m_Uniform;
		move.m_Uniform = nullptr;
	}
	...
	UniformBuffer::UniformInfo& UniformBuffer::UniformInfo::operator=(UniformInfo&& move) noexcept
	{
		m_Name         = std::move(move.m_Name);
		m_Uniform      = move.m_Uniform;
		move.m_Uniform = nullptr;
	...
	void UniformFloat::CopyFrom(const Uniform* other)
	{
		...
		const UniformFloat* otherV = reinterpret_cast<const UniformFloat*>(other);
	...
	void UniformFVec2::CopyFrom(const Uniform* other)
	{
		...
		const UniformFVec2* otherV = reinterpret_cast<const UniformFVec2*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformFVec3::CopyFrom(const Uniform* other)
	{
		...
		const UniformFVec3* otherV = reinterpret_cast<const UniformFVec3*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformFVec4::CopyFrom(const Uniform* other)
	{
		...
		const UniformFVec4* otherV = reinterpret_cast<const UniformFVec4*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformInt::CopyFrom(const Uniform* other)
	{
		...
		const UniformInt* otherV = reinterpret_cast<const UniformInt*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformIVec2::CopyFrom(const Uniform* other)
	{
		...
		const UniformIVec2* otherV = reinterpret_cast<const UniformIVec2*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformIVec3::CopyFrom(const Uniform* other)
	{
		...
		const UniformIVec3* otherV = reinterpret_cast<const UniformIVec3*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformIVec4::CopyFrom(const Uniform* other)
	{
		...
		const UniformIVec4* otherV = reinterpret_cast<const UniformIVec4*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformUInt::CopyFrom(const Uniform* other)
	{
		...
		const UniformUInt* otherV = reinterpret_cast<const UniformUInt*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformUVec2::CopyFrom(const Uniform* other)
	{
		...
		const UniformUVec2* otherV = reinterpret_cast<const UniformUVec2*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformUVec3::CopyFrom(const Uniform* other)
	{
		...
		const UniformUVec3* otherV = reinterpret_cast<const UniformUVec3*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformUVec4::CopyFrom(const Uniform* other)
	{
		...
		const UniformUVec4* otherV = reinterpret_cast<const UniformUVec4*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformFMat2::CopyFrom(const Uniform* other)
	{
		...
		const UniformFMat2* otherV = reinterpret_cast<const UniformFMat2*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformFMat3::CopyFrom(const Uniform* other)
	{
		...
		const UniformFMat3* otherV = reinterpret_cast<const UniformFMat3*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformFMat4::CopyFrom(const Uniform* other)
	{
		...
		const UniformFMat4* otherV = reinterpret_cast<const UniformFMat4*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformTexture2D::CopyFrom(const Uniform* other)
	{
		...
		const UniformTexture2D* otherV = reinterpret_cast<const UniformTexture2D*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformTexture2DArray::CopyFrom(const Uniform* other)
	{
		...
		const UniformTexture2DArray* otherV = reinterpret_cast<const UniformTexture2DArray*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformTexture3D::CopyFrom(const Uniform* other)
	{
		...
		const UniformTexture3D* otherV = reinterpret_cast<const UniformTexture3D*>(other);
		SetValue(otherV->GetValue());
	}
	...
	void UniformTextureCubeMap::CopyFrom(const Uniform* other)
	{
		...
		const UniformTextureCubeMap* otherV = reinterpret_cast<const UniformTextureCubeMap*>(other);
		SetValue(otherV->GetValue());
	}
